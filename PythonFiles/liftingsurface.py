...
class LiftingSurface:
    ...
    def __init__(self, side, ApexPoint, SweepFunct, DihedralFunct, TwistFunct, ChordFunct, AirfoilFunct, LooseSurf=1, SegmentNo=11, TipRequired = 1, SectionsRequired = False):
    ...
    def GenerateLiftingSurface(self, ChordFactor, ScaleFactor, OptimizeChordScale=0):
        ...
        return str(LS), ActualSemiSpan, LSP_area,  RootChord, AR, WingTip, Sections
